...
- Quando respondido, use a tool para atualizar a collection 'clientes' com o campo 'empresa'.
...
Lembre-se: avance apenas UMA etapa por vez. Mantenha as respostas curtas e formatadas para o WhatsApp.`,
  ...
  (app) => {
    // Keep original empty so we don't accidentally drop tools going backwards
  },
)
